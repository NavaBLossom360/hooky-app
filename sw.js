...
const CACHE = "hooky-v4";
const SHELL = ["./", "index.html", "config.js", "styles.css", "safety.js", "store.js", "call.js", "app.js", "icon.svg", "manifest.json", "legal.html", "assets/wordmark.png", "assets/icon-192.png"];
